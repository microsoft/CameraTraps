...
# %%
from src.utils.batch_detection_cropping import batch_detection
from src.utils.utils import save_crop_images
...
def main(
    ...
    # Get crops for each dataset
    results = batch_detection(conf.dataset_root)
    save_crop_images(results, os.path.join(conf.output_dir, "cropped_resized"), train_annotations, conf.dataset_root)
    save_crop_images(results, os.path.join(conf.output_dir, "cropped_resized"), val_annotations, conf.dataset_root)
    save_crop_images(results, os.path.join(conf.output_dir, "cropped_resized"), test_annotations, conf.dataset_root)
