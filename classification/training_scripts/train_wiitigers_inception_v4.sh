DATASET_NAME=wiitigers
DATASET_DIR=/data2/wiitigers/wiitigers_cropped_tfrecords
#TRAIN_DIR=./log/$(date +"%Y-%m-%d_%H.%M.%S")_wiitigers_incv4
TRAIN_DIR=./log/2019-06-12_07.08.20_wiitigers_incv4
