...
#%% Task: empty and non-empty classification
...
def pred_seq_max_conf(detector_output_images_entries):
    """
    Surface the max_detection_conf field
    """
...
def empty_accuracy_seq_level(gt_db_indexed, detector_output_path, file_to_image_id, threshold=0.5):
    ...
    Args:
        ...
        file_to_image_id: see load_api_results.py
    Returns:
    ...
    return accuracy, gt_seq_level, pred_seq_level
