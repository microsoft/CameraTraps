...
# !! Note that this class is a copy of that in detection/run_tf_detector.py
# Please modify it there and copy over. Reason: do not want to include tensorflow in environment.yml
class DetectorUtils:
    """
