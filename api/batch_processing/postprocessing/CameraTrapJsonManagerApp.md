...
| Confidence threshold     | Only detections with confidence above this threshold will be included in the output file.  Leave blank for no thresholding.  All other things being equal, leave this blank.
