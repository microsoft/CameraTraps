...
At this point, the json-formatted API string for all jobs (typically just one, unless you used the "folder_names" feature to create multiple jobs), and you're ready to submit.
