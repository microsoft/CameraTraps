...
### Pytorch-Wildlife Version 1.2.2

### Pytorch-Wildlife Version 1.2.1
- [What's New](docs/announcement.md)
...
```
Please refer to our [installation guide](docs/installation.md) for more installation information.
