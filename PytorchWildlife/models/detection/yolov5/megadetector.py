...
class MegaDetectorV6(YOLOV5Base):
    """
    MegaDetectorV5 is a specialized class derived from the YOLOV5Base class 
    that is specifically designed for detecting animals, persons, and vehicles.
    ...
    IMAGE_SIZE = 640  # image size used in training
    STRIDE = 64
    CLASS_NAMES = {
        0: "animal",
        1: "person",
    ...
    def __init__(self, weights=None, device="cpu", pretrained=True, version='yolov9c'):
        ...
        if pretrained:
            if version == 'yolov9c':
                url = "https://zenodo.org/records/11192829/files/MDV6b-yolov9c.pt?download=1"
            elif version =='rtdetrl':
                url = "https://zenodo.org/records/11192829/files/MDV6b-rtdetrl.pt?download=1"
            else:
