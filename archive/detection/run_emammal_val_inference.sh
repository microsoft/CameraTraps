...
DETECTION_TFRECORD_FILE=/ai4efs/models/object_detection/faster_rcnn_inception_resnet_v2_atrous/$EXPERIMENT/predictions/emammal_val_detections.tfrecord-00000-of-00001 

DETECTION_DICT_FILE=/ai4efs/models/object_detection/faster_rcnn_inception_resnet_v2_atrous/$EXPERIMENT/predictions/emammal_val.p

TF_RECORD_FILES=$(ls -1 /ai4efs/tfrecords/emammal/oneclass/emammal_imerit/val* | tr '\n' ',')
